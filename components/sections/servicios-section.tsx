          ...
          {serviceKeys.map((key, index) => {
            ...
            return (
              <motion.div key={key} variants={itemVariant}>
                <Card className="relative border-0 shadow-lg hover:shadow-xl transition-all duration-300 card-hover bg-white dark:bg-gray-800 overflow-hidden">
                  ...
                  <CardContent>
                    <p className="text-gray-600 dark:text-gray-300">
                      {content.services[key].description}
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
